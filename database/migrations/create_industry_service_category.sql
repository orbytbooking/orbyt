-- Migration: Create industry_service_category table
-- Created: 2026-01-24
-- Description: Creates the industry_service_category table to store service categories with all configuration options
