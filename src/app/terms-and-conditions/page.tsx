            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Welcome to Premier Pro Cleaners. By accessing our website and using our services, 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Premier Pro Cleaners provides professional cleaning services including but not limited to:
                </p>
              ...
              <section className="mb-8">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p className="leading-relaxed">
                    Premier Pro Cleaners is fully insured and bonded. We take utmost care in providing 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  is the property of Premier Pro Cleaners and is protected by copyright and trademark laws. 
              ...
              <section className="mb-8">
                ...
                <div className="bg-muted/50 rounded-lg p-6 space-y-2">
                  ...
                  <p className="text-muted-foreground">Email: info@premierprocleaners.com</p>
