...
export default function IndustryFormLocationsPage() {
  ...
  const listHref = `/admin/settings/industries/form-3/locations?industry=${encodeURIComponent(industry)}${industryId ? `&industryId=${industryId}` : ""}`;
  const newHref = `/admin/settings/industries/form-3/locations/new?industry=${encodeURIComponent(industry)}${industryId ? `&industryId=${industryId}` : ""}`;
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>{industry} – Form 3 / Locations</CardTitle>
          <CardDescription>
