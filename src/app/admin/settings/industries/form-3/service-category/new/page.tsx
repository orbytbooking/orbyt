...
import { FORM1_NEW_CATEGORY_FORM_DEFAULTS } from "@/lib/form3DefaultServiceCategoryConfig";
...
export default function ServiceCategoryNewPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      router.push(
        `/admin/settings/industries/form-3/service-category?industry=${encodeURIComponent(industry)}${scopeQs}`,
      );
    } catch (error) {
