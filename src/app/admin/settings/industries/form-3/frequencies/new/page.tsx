...
export default function FrequencyNewPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      router.push(
        `/admin/settings/industries/form-3/frequencies?industry=${encodeURIComponent(industry)}${scopeQs}`,
      );
    } catch (error) {
        ...
        <CardContent>
            ...
            <TabsContent value="dependencies" className="mt-4 space-y-6">
              ...
              <div className="border-t pt-6">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-muted-foreground">{isSinglePageScope ? "Form 2" : "Form 3"}</p>
                </div>
          ...
          <div className="mt-6 flex gap-2 justify-end">
            <Button
              ...
              onClick={() =>
                router.push(
                  `/admin/settings/industries/form-3/frequencies?industry=${encodeURIComponent(industry)}${industryId ? `&industryId=${industryId}` : ""}${scopeQs}`,
                )
              }
            >
              Cancel
