...
export default function IndustryFormLocationsPage() {
  ...
  const listHref = `/admin/settings/industries/form-2/locations?industry=${encodeURIComponent(industry)}${industryId ? `&industryId=${industryId}` : ""}`;
  const newHref = `/admin/settings/industries/form-2/locations/new?industry=${encodeURIComponent(industry)}${industryId ? `&industryId=${industryId}` : ""}`;
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>{industry} – Form 2 / Locations</CardTitle>
          <CardDescription>
