    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {isForm4
              ? "Form 2 uses unit-based pricing parameters: set a price and time per unit; the customer’s total is rate × quantity (e.g. $/sq ft × square feet)."
              : isForm3
                ? "Configure the Form 3 booking catalog: locations through items, add-ons, and extras (no packages)."
                : isForm2
                  ? "Configure the single-page booking catalog: locations through packages, add-ons, and extras — same data model as Form 2, scoped for Form 2."
            ...
            {isForm2 ? (
              ...
              <Card className="border-dashed">
                ...
                <CardContent className="flex items-end justify-between">
                  ...
                  <Button asChild size="sm">
                    <Link
                      href={`/admin/settings/industries/form-2/pricing-parameter?industry=${encodeURIComponent(industryName)}${idQs}${scopeQs}`}
                    >
                      Manage
                    </Link>
                  </Button>
