    ...
    <div className="space-y-6">
      <div className="flex justify-end">
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={() => router.push(`/admin/settings/industries/form-2/frequencies/new?industry=${encodeURIComponent(industry)}${industryIdQs}${scopeQs}`)}>Add New</Button>
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => router.push(`/admin/settings/industries/form-2/frequencies/new?industry=${encodeURIComponent(industry)}${industryIdQs}&editId=${r.id}${scopeQs}`)}>Edit</DropdownMenuItem>
