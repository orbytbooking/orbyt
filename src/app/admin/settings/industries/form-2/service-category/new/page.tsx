...
export default function ServiceCategoryNewPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      router.push(
        `/admin/settings/industries/form-2/service-category?industry=${encodeURIComponent(industry)}${scopeQs}`,
      );
    } catch (error) {
      ...
      <Card>
        ...
        <CardContent>
          <Tabs defaultValue="details" className="w-full">
            ...
            <TabsContent value="dependencies" className="mt-4 space-y-6">
              <div className="space-y-6">
                ...
                {/* Exclude Parameters (Form 2 only) */}
                {!isForm2 && (
                <div className="space-y-3">
          ...
          <div className="mt-6 flex gap-2 justify-end">
            <Button 
              variant="outline" 
              onClick={() => router.push(`/admin/settings/industries/form-2/service-category?industry=${encodeURIComponent(industry)}`)}
            >
              Cancel
            </Button>
            <Button 
