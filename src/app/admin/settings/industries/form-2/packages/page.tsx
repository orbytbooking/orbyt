...
export default function IndustryFormPricingParameterPage() {
  ...
  const itemsBasePath = isForm2
    ...
    : "/admin/settings/industries/form-2/pricing-parameter/manage-variables";
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Exclude parameters are only used in Form 2 pricing flow.
        if (!isForm2 && !isForm4) {
    ...
    <div className="space-y-6">
      {isForm2 ? (
        ...
        <>
          ...
          {/* Exclude Parameters Section (Form 2 only) */}
          {!isForm2 && !isForm4 && (
          <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <Button 
                variant="outline" 
                onClick={() => router.push(`/admin/settings/industries/form-2/pricing-parameter/exclude-parameters/new?industry=${encodeURIComponent(industry)}&industryId=${industryId}`)}
              >
                Add New
              </Button>
                    ...
                    <TableRow key={param.id}>
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              onClick={() => router.push(`/admin/settings/industries/form-2/pricing-parameter/exclude-parameters/new?industry=${encodeURIComponent(industry)}&industryId=${industryId}&editId=${param.id}`)}
                            >
                              Edit
                            </DropdownMenuItem>
                            <DropdownMenuItem
