...
export default function ExtraNewPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      router.push(
        `/admin/settings/industries/form-4/extras?industry=${encodeURIComponent(industry)}&industryId=${industryId}${scopeQs}`,
      );
    } catch (error) {
          ...
          <Tabs defaultValue="details" className="w-full">
            ...
            <TabsContent value="dependencies" className="mt-4 space-y-6">
              <div className="space-y-4">
                ...
                {!(bookingFormScope === "form2" && listing_kind === "extra") && (
                  <div className="space-y-2">
                    <Label>
                      {listing_kind === "addon"
                        ? isForm3
