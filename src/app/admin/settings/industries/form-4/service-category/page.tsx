    ...
    <div className="space-y-6">
      <div className="flex justify-end">
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={() => router.push(`/admin/settings/industries/form-4/service-category/new?industry=${encodeURIComponent(industry)}&industryId=${industryId || ''}${scopeQs}`)}>Add New</Button>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{industry} - Form 4 / Service Category</CardTitle>
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => router.push(`/admin/settings/industries/form-4/service-category/new?industry=${encodeURIComponent(industry)}&industryId=${industryId || ''}&editId=${category.id}${scopeQs}`)}>Edit</DropdownMenuItem>
