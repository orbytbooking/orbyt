...
export default function IndustryForm1Page() {
  ...
  const [bookingFormScope, setBookingFormScope] = useState<BookingFormScope>("form4");
  ...
  useEffect(() => {
    ...
    const fetchIndustryData = async () => {
      try {
        ...
        const effectiveScope: BookingFormScope = fromUrl === "form4" ? "form4" : "form4";
  ...
  const formBasePath = "form-4";
  const formLabel = "Form 4";
