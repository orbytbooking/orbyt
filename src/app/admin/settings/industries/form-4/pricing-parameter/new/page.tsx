...
export default function PricingParameterNewPage() {
  ...
  const packagesBasePath = isForm2
    ...
    : "/admin/settings/industries/form-4/pricing-parameter";
                ...
                {isForm4 ? (
                  <div className="grid gap-4 md:grid-cols-2">
                          ...
                          <div className="space-y-1">
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                ...
                                setValidationErrors((prev) => ({
                                  ...prev,
                                  hours: validateHours(value, form.minutes),
                                  minutes: validateMinutes(form.minutes, value),
                                }));
                              }}
                              onBlur={(e) =>
                                setValidationErrors((prev) => ({
                                  ...prev,
                                  hours: validateHours(e.target.value, form.minutes),
                                  minutes: validateMinutes(form.minutes, e.target.value),
                                }))
                              }
                              placeholder="0"
                          ...
                          <div className="space-y-1">
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                ...
                                setValidationErrors((prev) => ({
                                  ...prev,
                                  minutes: validateMinutes(value, form.hours),
                                  hours: validateHours(form.hours, value),
                                }));
                              }}
                              onBlur={(e) =>
                                setValidationErrors((prev) => ({
                                  ...prev,
                                  minutes: validateMinutes(e.target.value, form.hours),
                                  hours: validateHours(form.hours, e.target.value),
                                }))
                              }
                              placeholder="0"
                    ...
                    <div className="space-y-3 rounded-lg border bg-card p-4 shadow-sm">
                      <p className="text-sm font-semibold tracking-wide text-muted-foreground">M.L</p>
                      <div className="space-y-2">
                        <Label htmlFor="price-merchant" className="text-sm text-muted-foreground">Pricing</Label>
                        <div className="flex items-center gap-1">
                          <span className="text-sm text-muted-foreground">$</span>
                          <Input
                            id="price-merchant"
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-4 max-w-xs">
                          <div className="space-y-1">
                            <Label htmlFor="hours-merchant" className="text-xs text-muted-foreground">Hours</Label>
                            <Input
                              id="hours-merchant"
                              type="number"
                              min={0}
                              value={form.hoursMerchant}
                              onChange={(e) => setForm((p) => ({ ...p, hoursMerchant: e.target.value }))}
                              placeholder="0"
                            />
                          </div>
                          <div className="space-y-1">
                            <Label htmlFor="minutes-merchant" className="text-xs text-muted-foreground">Minutes</Label>
                            <Input
                              id="minutes-merchant"
                              type="number"
                              min={0}
                              max={59}
                              value={form.minutesMerchant}
                              onChange={(e) => setForm((p) => ({ ...p, minutesMerchant: e.target.value }))}
                              placeholder="0"
                            />
                          </div>
                        </div>
