            ...
            <div className="md:w-1/2">
              <div className="bg-gray-50 p-8 rounded-xl">
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                  <img
                    src="/images/business-account-preview.png"
                    alt="Business account dashboard — multi-location management, bookings, and team overview"
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 md:pr-12 md:order-1">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                <img
                  src="/images/smart-notifications-preview.png"
                  alt="Smart Notifications — email and SMS templates, toggles, and automated reminders"
                  className="w-full h-auto rounded-md object-cover object-top"
                />
              </div>
            </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 md:pr-12 md:order-1">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                <img
                  src="/images/ai-receptionist-preview.png"
                  alt="AI Virtual Receptionist — chat widget on booking page answering service and booking questions"
                  className="w-full h-auto rounded-md object-cover object-top"
                />
              </div>
            </div>
