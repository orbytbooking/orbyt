...
/** Orbyt marketing / help-center copy (not tenant-specific; not tied to admin CRM FAQs). */
const ORBYT_HELP_CENTER_FAQS: FAQ[] = [
  {
    id: '1',
...
export default function FAQPage() {
  const faqs = ORBYT_HELP_CENTER_FAQS;
            ...
            {faqs.map((faq) => (
              <div key={faq.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <details className="group">
                  ...
                  <div className="px-6 pb-6 -mt-2 text-gray-600">{faq.answer}</div>
                </details>
              </div>
            ))}
          </div>
